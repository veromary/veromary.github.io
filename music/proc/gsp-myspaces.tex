...
% minimal space between letters of different words. 17
\grecreatedim{interwordspacetext}{0.25 cm plus 0.05 cm minus 0.05 cm}{scalable}%
...
% (new bar spacing algorithm only) 18
\grecreatedim{interwordspacetext@bars}{0.25 cm}{scalable}%
% minimal space between letters of different syllable texts for text around bars,
% euouae context
...
% rubber length that will be added around bars in new bar spacing algorithm 0
...
% space between the text of previous syllable and text associated with a bar (old bar spacing algorithm only) 24611
\grecreatedim{textbartextspace}{0.29611 cm plus 0.13672 cm minus 0.04921 cm}{scalable}%
